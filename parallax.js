/*!
 * parallax.js v1.3.2 (http://pixelcog.github.io/parallax.js/)
...
;(function ( $, window, document, undefined ) {
  ...
  $.extend(Parallax.prototype, {
    ...
    checkResponsiveImages: function() {
      if (!this.responsive) {
        return;
      }
      ...
      for (var i = 0, l = this.imageSources.length; i < l; i++) {
        var src = this.imageSources[i].getAttribute('data-image-src');
        var media = this.imageSources[i].getAttribute('data-media-query');

        if (src && (!media || Modernizr.mq(media))) {
          matches.push(src);
        }
      }
      ...
      if (matches.length) {
        ...
        if (!exp.test(this.$slider.attr('src'))) {
          var alreadyLoaded = this.loadedImages[src];
